            ...
            <div class="col-md-12">
                <div class="card" style="border: 1px solid blue;">
                    <div class="card-header">
                    	{{ Form::open(array('url' => 'products', 'files' => true, 'method' => 'post')) }}
					        ...
					        <hr />
					        <a class="btn btn-small btn-success" href="{{ URL::to('products') }}"><span class="oi oi-chevron-left" aria-hidden="true"></span> Back</a>
